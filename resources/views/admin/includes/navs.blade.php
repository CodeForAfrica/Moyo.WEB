<div class="navs">
    <ul>
        ...
        <a href=""><li class="{{ $data['page'] == 'WrongChecks' ? 'active' : '' }}"><span class="fa fa-warning" style="font-size:22px;margin-right:8px;"></span>Wrong Checks</li></a>
        <a href="#"><li class="{{ $data['page'] == 'Users' ? 'active' : '' }}"><span class="fa fa-users" style="font-size:22px;margin-right:8px;"></span>Users</li></a>
    </ul>
</div><!-- close div .navs -->